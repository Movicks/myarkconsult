...
const HeroSection = () => {
  return (
    <section id="hero" className="relative h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 lg:px-10 z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="animate-fade-in text-white md:pr-1">
          ...
          <div className="hidden md:block">
            <div className="relative">
              ...
              <div className="absolute -bottom-20 left-[30rem] w-32 h-32 bg-consultant-blue rounded-full opacity-15 animate-pulse" style={{animationDelay: "0.9s"}}>jj</div>
              </div>
            </div>
          </div>
        </div>
